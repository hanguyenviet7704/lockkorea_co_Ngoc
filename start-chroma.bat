...
docker ps | findstr lockerkorea-chromadb >nul 2>&1
if %errorlevel% equ 0 (
    echo.
...
if %attempts% gtr %max_attempts% (
    ...
    echo Check logs with: docker logs lockerkorea-chromadb
    pause
    exit /b 1
)
...
echo Container: lockerkorea-chromadb
echo.
...
echo ========================================
echo View logs:  docker logs lockerkorea-chromadb -f
